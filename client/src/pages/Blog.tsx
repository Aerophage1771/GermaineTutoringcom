        ...
        <div className="container mx-auto px-4 pt-16 pb-8 md:pt-20 md:pb-10">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <div className="w-full flex flex-col items-center">
              ...
              <p className="text-foreground/80 text-lg md:text-xl leading-relaxed mb-5 max-w-2xl">
            ...
            {featuredPost && (
              <aside className="w-full max-w-xl mt-10">
                <p className="flex items-center justify-center gap-1.5 text-xs font-bold text-accent uppercase tracking-wider mb-2">
                  <Sparkles className="w-3.5 h-3.5" />
                  Featured Article
                </p>
                <Link href={`/blog/${featuredPost.slug}`} className="group block bg-white rounded-2xl border border-border p-5 hover:border-primary/40 hover:shadow-lg transition-all duration-200 cursor-pointer no-underline text-left">
